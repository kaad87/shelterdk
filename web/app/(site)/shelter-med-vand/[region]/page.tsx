...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = `Shelter med vand ${prep} ${regionName} – kort og faciliteter | ShelterDK`;
  const description = `Find shelters med vand ${prep} ${regionName}. Se kort, liste, faciliteter og praktisk info.`;
