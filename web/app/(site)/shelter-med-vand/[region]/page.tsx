...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = `Shelter med vand ${prep} ${displayName} – kort og faciliteter | ShelterDK`;
  const description = `Find shelters med vand ${prep} ${displayName}. Se kort, liste, faciliteter og praktisk info.`;
