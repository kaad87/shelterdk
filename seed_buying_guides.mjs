...
const guides = [
  {
    ...
    entries: [
      { product_id: "backpackerlife-72997", score: 8.7, award_label: "Bedst i test", best_for: "Alround 2-3-sæson", editorial_note: "Snugpak Travelpak 3 rammer sweet-spottet: pålidelig varme, kompakt pakmål og et anerkendt mærke til en skarp pris. Vores alround-favorit til det meste af året.", pros: ["Fremragende værdi", "Kompakt og let", "Pålideligt Snugpak-mærke"], cons: ["Syntetisk fylder lidt mere", "Ikke til streng vinter"], specs: { fyld: "syntetisk", form: "mumie", saeson: "2-3-sæsons" } },
      ...
      { product_id: "backpackerlife-666124", score: 7.8, award_label: "Bedste til begyndere", best_for: "Begynder / 3-sæson", editorial_note: "Highlander Zeta 150 er en enkel, billig pose — perfekt til den allerførste sheltertur uden at bruge en formue.", pros: ["Billig indgang", "Enkel og nem", "Fin til milde nætter"], cons: ["Basal kvalitet", "Ikke til kulde"], specs: { fyld: "syntetisk", form: "mumie" } },
    ],
  },

  {
    ...
    entries: [
      ...
      { product_id: "outmore-4897028447216", score: 8.3, award_label: "Bedste letvægt", best_for: "Letvægt vandring", editorial_note: "Traverse Core Mummy er et let, mumieformet underlag — godt til vandrere der vil pakke småt og ligge isoleret.", pros: ["Let og kompakt", "Mumieform til lavt pakmål", "God værdi"], cons: ["Smallere end rektangulære", "Kan punktere"], specs: { type: "oppustelig", form: "mumie" } },
      { product_id: "outmore-5709388148063", score: 8.4, award_label: "Bedste til vinter", best_for: "Tyk + varm til kulde", editorial_note: "Easy Camp Skylark er 10 cm tykt og isolerende — holder kulden fra jorden væk på de kolde nætter, og er behageligt at ligge på.", pros: ["10 cm tykt — varmt og blødt", "God isolering mod jord", "Behagelig"], cons: ["Fylder en del", "Tungere"], specs: { type: "selvoppustende", tykkelse: "10 cm" } },
...

  {
    ...
    entries: [
      ...
      { product_id: "backpackerlife-463219", score: 8.0, award_label: "Bedste budget-familie", best_for: "Familie på budget", editorial_note: "Treklife UV Block XL 4P giver familieplads til en skarp pris — godt til weekendture med børn, og med UV-beskyttende dug.", pros: ["God plads for prisen", "UV-beskyttende dug", "Fint til 4"], cons: ["Tungere", "Basal materialekvalitet"], specs: { personer: 4, saeson: "3-sæsons" } },
...

  {
    ...
    entries: [
      ...
      { product_id: "outmore-5709388160706", score: 8.4, award_label: "Bedste komfort", best_for: "Plads + komfort", editorial_note: "Outwell Campion Lux XL giver ekstra plads at vende sig i — behagelig til den der ikke kan lide stramme mumieposer på lune nætter.", pros: ["God plads (XL)", "Behagelig komfort", "Fin til sommer/camping"], cons: ["Fylder mere", "Kun mildt vejr"], specs: { fyld: "syntetisk", form: "rektangulær" } },
...

  {
    ...
    entries: [
      ...
      { product_id: "outmore-5709388149411", score: 8.1, award_label: "Bedste robuste", best_for: "Robust til camping", editorial_note: "Robens Campground 75 er et robust, behageligt underlag til basecamp og længere ophold — bygget til at holde.", pros: ["Robust og holdbar", "Behagelig", "Pålideligt Robens-mærke"], cons: ["Tungere", "Mest til camping"], specs: { type: "selvoppustende" } },
